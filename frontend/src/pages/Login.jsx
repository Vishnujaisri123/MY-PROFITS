  ...
  return (
    <div className="app-grid" style={styles.container}>
      <div className="glass" style={styles.card}>
        <h1 style={styles.title}>SYSTEM ENTRANCE</h1>
        ...
        <div style={styles.footer}>
          New operator? <Link to="/signup" style={styles.link}>Register Identity</Link>
        </div>
      </div>
    </div>
  );
...
const styles = {
  ...
  card: {
    ...
    maxWidth: "400px",
    textAlign: "center",
    borderTop: "2px solid #00ffe1",
    boxShadow: "0 0 30px rgba(0, 255, 225, 0.2)",
  },
  title: {
